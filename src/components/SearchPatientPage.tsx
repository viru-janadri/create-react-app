...
const SearchPatientPage: React.FC<SearchPatientPageProps> = ({
  ...
  const mockPatients: Patient[] = [
    ...
    },
    {
      ...
      gender: "M",
      age: "58",
      birthdate: "03/11/1967",
      patientCode: "20000006",
      bed: "107",
      status: "stable",
    },
    {
    ...
    },
    {
      ...
      gender: "M",
      age: "47",
      birthdate: "04/18/1978",
      patientCode: "20000012",
      bed: "113",
      status: "improving",
    },
    {
    ...
    },
    {
      ...
      gender: "M",
      age: "62",
      birthdate: "08/07/1963",
      patientCode: "20000014",
      bed: "115",
      status: "critical",
    },
  ];
  ...
  const filteredPatients = mockPatients.filter((patient) => {
    ...
    const matchesSex = sex === "" || patient.gender === sex;
    const matchesPatientCode =
      patientCode === "" || patient.patientCode.includes(patientCode);
        ...
        <FlexBox flexDirection="column" gap={8} style={{ height: "100%" }}>
          ...
          >
            ...
            >
              ...
              <div style={{ width: "18%", paddingLeft: "0.5rem" }}>
                Family Name
              </div>

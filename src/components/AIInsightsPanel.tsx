...
import { Card, CardHeader, CardContent, H3, FlexBox, Label, Button } from "@filament/react";
...
import { Prediction, PredictiveAlarmService } from '../services/PredictiveAlarmService';
    ...
    <Card style={{ 
      ...
      <CardContent>
        <Label variant="descriptor" style={{ marginBottom: '16px' }}>
          Showing early warning predictions before conventional alarms would trigger
        </Label>
          ...
          predictions.map(prediction => (
            ...
            >
              <FlexBox justifyContent="space-between" alignItems="center">
                ...
                <Label variant="descriptor" style={{ 
              ...
              <FlexBox flexDirection="column" gap={4} style={{ marginTop: '8px' }}>
                <Label>{prediction.message}</Label>
                <Label variant="descriptor">
                  Current: {prediction.currentValue} • Time to alarm: {prediction.timeToAlarm}
                </Label>
